...
import { updateTeamLead, type UpdateTeamLeadPayload, type UpdateTeamLeadResponse } from "@/services/api/lifecycle-old/update-team-lead";
import { LIFECYCLE_TEAMS_QUERY_KEY } from "@/features/lifecycle-old/use-get-lifecycle-teams";
