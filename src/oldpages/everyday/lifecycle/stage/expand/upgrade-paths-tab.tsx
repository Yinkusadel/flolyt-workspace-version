...
import { ModelAnUpgradeModal } from "@/oldpages/everyday/lifecycle/stage/modals/model-an-upgrade-modal";
import { EYEBROW_CLASS } from "@/lib/lifecycle-data";
import { formatCount, formatPercent } from "@/lib/format-measured-value";
import { EXPAND_MODEL_UPGRADE_PRESET } from "@/oldpages/everyday/lifecycle/stage/expand/data";
import { useGetExpandUpgradePaths } from "@/features/lifecycle-old/use-get-expand-upgrade-paths";
import type { UpgradePathMoveDto } from "@/services/api/lifecycle-old/get-expand-upgrade-paths";
