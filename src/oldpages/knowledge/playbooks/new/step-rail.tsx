...
const STEPS = ["What it is for", "Preconditions", "Steps and measurement"];

/** The 3-pill wizard rail for /playbooks/new (PB08-PB10). */
export function NewPlaybookRail({ active }: { active: number }) {
  return (
