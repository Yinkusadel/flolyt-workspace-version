...
import { SEGMENTS_STATE } from "@/oldpages/customers/segments/data";
import { AllSegmentsState } from "@/oldpages/customers/segments/states/all-segments";
import { FirstSegmentState } from "@/oldpages/customers/segments/states/first-segment";
import { NoSegmentsYetState } from "@/oldpages/customers/segments/states/no-segments-yet";
import { SearchState } from "@/oldpages/customers/segments/states/search";
