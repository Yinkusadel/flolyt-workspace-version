...
import { SuppressedBar } from "@/oldpages/customers/campaigns/suppressed-bar";
import { CP07_PEOPLE_BAR_ROWS, CP07_RULE_ROWS, CP_CHIP_TONE, CP_TONE_CLASS } from "@/oldpages/customers/campaigns/data";
