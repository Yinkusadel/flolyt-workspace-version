...
const STEPS = ["Who it reaches", "What it says", "Guardrails", "Review"];

/** The 4-pill wizard rail for /campaigns/new (CP09-CP12). */
export function NewCampaignRail({ active }: { active: number }) {
  return (
