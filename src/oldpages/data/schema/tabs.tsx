...
import { SM_TABS, type SmTab } from "@/oldpages/data/schema/data";

const TAB_HREF: Record<SmTab, string> = {
  Fields: "/schema",
...
/** Shared 6-tab bar across the /schema index's "full" state and its five standalone sibling routes. */
export function SchemaTabs({ active }: { active: SmTab }) {
  return (
