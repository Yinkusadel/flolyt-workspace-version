...
import { SchemaTabs } from "@/oldpages/data/schema/tabs";
import { SchemaKvList } from "@/oldpages/data/schema/kv-list";
import { ConfirmARenameModal } from "@/oldpages/data/schema/modals/confirm-a-rename-modal";
import { SM06_CHANGE_ROWS, SM06_WHAT_HAPPENS_KV, SM_TONE_CLASS } from "@/oldpages/data/schema/data";
