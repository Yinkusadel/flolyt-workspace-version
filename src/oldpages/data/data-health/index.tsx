import { DATA_HEALTH_STATE } from "@/oldpages/data/data-health/data";
import { NothingToCheckState } from "@/oldpages/data/data-health/states/nothing-to-check";
import { FirstFailureState } from "@/oldpages/data/data-health/states/first-failure";
import { RightNowState } from "@/oldpages/data/data-health/states/right-now";
