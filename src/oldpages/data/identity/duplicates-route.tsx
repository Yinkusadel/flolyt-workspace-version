...
import { IdentityTabs } from "@/oldpages/data/identity/tabs";
import { MergeTwoRecordsModal } from "@/oldpages/data/identity/modals/merge-two-records-modal";
import { ID06_DUPLICATE_ROWS, ID06_STATS, ID_KPI_TONE, ID_TONE_CLASS } from "@/oldpages/data/identity/data";
