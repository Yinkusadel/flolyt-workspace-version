...
const STEPS = ["What to connect", "Which fields", "How and how often", "Review"];

/** The 4-pill wizard rail for /data-sources/new (DS07-DS10). */
export function ConnectSourceRail({ active }: { active: number }) {
  return (
