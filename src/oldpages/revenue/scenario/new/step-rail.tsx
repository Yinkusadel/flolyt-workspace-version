...
import { WIZ_STEPS } from "@/oldpages/revenue/scenario/data";

/** The 4-pill wizard rail for /scenario/new (SC04-SC07). */
export function NewScenarioRail({ active }: { active: number }) {
  return (
