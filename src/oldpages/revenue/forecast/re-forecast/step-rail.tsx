...
const STEPS = ["What has changed", "Your number"];

/** The 2-pill wizard rail for /forecast/:stage/re-forecast (FC08/FC09). */
export function ReForecastRail({ active }: { active: number }) {
  return (
