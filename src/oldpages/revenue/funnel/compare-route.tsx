...
import { BarRow } from "@/oldpages/everyday/lifecycle/stage/bar";
import { FunnelTabs } from "@/oldpages/revenue/funnel/tabs";
import { FN05_RULED_OUT_ROWS, FN05_WEEK_BARS } from "@/oldpages/revenue/funnel/data";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-[11.5px] text-ink-3">
          Where it bent · checkout to first order, all four markets over two weeks
        </p>
      </div>
