...
const STEPS = ["What against what", "What has to match"];

/** The 2-pill wizard rail for /benchmarks/new (BM11/BM12). */
export function NewComparisonRail({ active }: { active: number }) {
  return (
