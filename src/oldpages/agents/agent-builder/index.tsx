import { NothingBuiltState } from "@/oldpages/agents/agent-builder/states/nothing-built";
import { FirstBuiltState } from "@/oldpages/agents/agent-builder/states/first-built";
import { BuiltHereState } from "@/oldpages/agents/agent-builder/states/built-here";
import { AGENT_BUILDER_STATE } from "@/oldpages/agents/agent-builder/data";
