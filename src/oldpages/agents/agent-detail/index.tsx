import { BeforeReadingState } from "@/oldpages/agents/agent-detail/states/before-reading";
import { OverviewState } from "@/oldpages/agents/agent-detail/states/overview";
import { AGENT_DETAIL_STATE } from "@/oldpages/agents/agent-detail/data";
