...
import { AgentHeader } from "@/oldpages/agents/agent-detail/agent-header";
import { AgentDetailTabs } from "@/oldpages/agents/agent-detail/tabs";
import { AgentDetailKvList } from "@/oldpages/agents/agent-detail/kv-list";
import { EditThresholdModal } from "@/oldpages/agents/agent-detail/modals/edit-threshold-modal";
import { AN03_KV, AN03_ROWS, AN_TONE_CLASS } from "@/oldpages/agents/agent-detail/data";
