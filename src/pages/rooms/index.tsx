...
import { getRoomIndex, getRoomListCounts, SAVED_VIEWS } from "@/pages/rooms/data";
import { EMPTY_STATE_SOURCES, OTHER_STATES_EXPLAINERS } from "@/pages/rooms/index-content";
import { TONE_TEXT_CLASS } from "@/pages/rooms/tone";
import type { RoomListRow, RoomListState } from "@/pages/rooms/types";
  ...
  return (
    <tr key={room.id} className="border-b border-line last:border-0 hover:bg-paper-2">
      <td className="px-4 py-3.5">
        <Link to={`/rooms/${room.id}`} className="font-semibold whitespace-nowrap text-ink-2 hover:text-ink">
          {room.title}
        </Link>
      </td>
