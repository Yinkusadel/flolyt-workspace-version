...
import { ACQUIRE_GOAL_ROWS, ACQUIRE_TRIED_ROWS, type GoalRow, type TriedRow } from "@/pages/everyday/lifecycle/stage/acquire/data";
import { ACTIVATE_GOAL_ROWS, ACTIVATE_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/activate/data";
import { PRICE_GOAL_ROWS, PRICE_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/price/data";
import { ADOPT_GOAL_ROWS, ADOPT_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/adopt/data";
import { RETAIN_GOAL_ROWS, RETAIN_HISTORY_MID_INSIGHT, RETAIN_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/retain/data";
import { EXPAND_GOAL_ROWS, EXPAND_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/expand/data";
import { SUPPORT_GOAL_ROWS, SUPPORT_HISTORY_MID_INSIGHT, SUPPORT_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/support/data";
import { RENEW_GOAL_ROWS, RENEW_HISTORY_INSIGHT, RENEW_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/renew/data";
import { ADVOCATE_GOAL_ROWS, ADVOCATE_HISTORY_INSIGHT, ADVOCATE_HISTORY_MID_INSIGHT, ADVOCATE_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/advocate/data";
import { CHURN_GOAL_ROWS, CHURN_HISTORY_INSIGHT, CHURN_TRIED_ROWS } from "@/pages/everyday/lifecycle/stage/churn/data";
