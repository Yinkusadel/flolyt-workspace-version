...
import { ACQUIRE_CHANGE_ROWS, ACQUIRE_CHANGE_SOURCE_ROWS, type ChangeRow } from "@/pages/everyday/lifecycle/stage/acquire/data";
import { ACTIVATE_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/activate/data";
import { PRICE_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/price/data";
import { ADOPT_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/adopt/data";
import { RETAIN_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/retain/data";
import { EXPAND_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/expand/data";
import { SUPPORT_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/support/data";
import { RENEW_CHANGE_ROWS } from "@/pages/everyday/lifecycle/stage/renew/data";
import { ADVOCATE_CHANGE_ROWS, ADVOCATE_CHANGES_INSIGHT } from "@/pages/everyday/lifecycle/stage/advocate/data";
import { CHURN_CHANGE_ROWS, CHURN_CHANGES_INSIGHT } from "@/pages/everyday/lifecycle/stage/churn/data";
