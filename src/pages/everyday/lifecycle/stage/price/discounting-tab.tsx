...
import { PRICE_DISCOUNTING_KPIS, PRICE_DISCOUNT_GROUP_ROWS, PRICE_DISCOUNT_MEMORY_CARDS, type DiscountGroupRow, type PriceMemoryCard } from "@/pages/everyday/lifecycle/stage/price/data";
