...
| Inbox | [inbox.md](inbox.md) | 11/11 documented, 9/11 wired into `/inbox`, all 9 live-verified (thread read/reply confirmed 2026-09-19 once a real `Message` item existed); `read-all` + 3 draft endpoints still service/hook-only |
