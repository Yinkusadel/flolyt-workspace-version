...
| App shell | [app-shell.md](app-shell.md) | 7/7 documented (`/search /home /home/greeting /home/prompts /inbox /command-bar /sources`), service+hook scaffolded for the 3 `home*` routes, 0/7 wired |
